...
# amplitude_distribution documentation build
...
from amplitude_distribution import __version__ as release

# -- Project information -----------------------------------------------------

project = "amplitude_distribution"
author = "Kedro"
...
htmlhelp_basename = "amplitude_distributiondoc"
...
latex_documents = [
    (
        master_doc,
        "amplitude_distribution.tex",
        "amplitude_distribution Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "amplitude_distribution",
        "Project amplitude_distribution codebase.",
        "Data-Science",
    )
]
